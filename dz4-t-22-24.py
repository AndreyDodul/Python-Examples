...
n = []       # инициализируем массив 1
for i in range(int(input('Введите количество элементов массива 1: '))):
    n.append(int(input()))
print(*n)    # в этом виде не будут отображаться , и []
m = []       # инициализируем массив 2
for i in range(int(input('Введите количество элементов массива 2: '))):
    m.append(int(input()))
print(*m)
n_set = set(n)
m_set = set(m)
